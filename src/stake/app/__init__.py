...
def create_app(config,adapter_arg,pluginsPath_arg,logconfig_arg, selenium=False):
    ...
    global pluginsPath
    pluginsPath = pluginsPath_arg
    global logconfig
    logconfig = logconfig_arg
    global networkAdapter
    networkAdapter = adapter_arg
...
def get_log_max_rows():
    global logconfig
    return logconfig.maxrows
