...
$(function(){
    ...
    var $settings = $("#settings"),
        ...
        displaySidebar = function(display, triggerResize){
            triggerResize = triggerResize == undefined ? true : false;
           // $("#hidden-eye").toggleClass("glyphicon-eye-close glyphicon-eye-open");
            if (display == true){
                $body.removeClass("sidebar-hidden")
                $body.addClass("navbar-hidden")
                $("#hidden-eye").addClass("glyphicon-eye-open");
                $("#hidden-eye").removeClass("glyphicon-eye-close");
            } else {
                $body.addClass("sidebar-hidden")
                $body.removeClass("navbar-hidden")
                $("#hidden-eye").addClass("glyphicon-eye-close");
                $("#hidden-eye").removeClass("glyphicon-eye-open");
            }
            if (triggerResize){
                triggerChartsResize();
            }
